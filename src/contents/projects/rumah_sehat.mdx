...
- **Java Spring Boot** for the web application framework (monolithic fullstack)
- **Flutter** for the mobile application framework
- **MySQL** for the database management system (DBMS)
- **BootstrapCSS** for css component and utility classes
